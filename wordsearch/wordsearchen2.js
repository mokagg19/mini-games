  (function e(t, n, r) { function s(o, u) { if (!n[o]) { if (!t[o]) { var a = typeof require == "function" && require; if (!u && a) return a(o, !0); if (i) return i(o, !0); throw new Error("Cannot find module '" + o + "'") } var f = n[o] = { exports: {} }; t[o][0].call(f.exports, function (e) { var n = t[o][1][e]; return s(n ? n : e) }, f, f.exports, e, t, n, r) } return n[o].exports } var i = typeof require == "function" && require; for (var o = 0; o < r.length; o++)s(r[o]); return s })({
    1: [function (require, module, exports) {
      ...
      (function () {
        module.exports = ['ACTOR', 'DIPLOMA', 'JOURNALIST', 'SECRETARY', 'ARTIST', 'DOCTOR', 'KING', 'SHOP', 'ASSISTANT', 'BOSS', 'LETTER', 'SHOPPER', 'BREAK', 'BUSINESS', 'DRIVER', 'EARN', 'MANAGER', 'MECHANIC', 'SINGER', 'STAFF', 'BUSINESSMAN', 'BUSINESSWOMAN', 'EMAIL', 'ENGINEER', 'MEETING', 'MESSAGE', 'STUDENT', 'TEACHER', 'CHEMIST', 'EXPLORER', 'MUSICIAN', 'TENNIS', 'PLAYER', 'CLEANER', 'FACTORY', 'NURSE', 'TOUR', 'GUIDE', 'COACH', 'FARM', 'OCCUPATION', 'UNIFORM', 'COMPANY', 'FARMER', 'OFFICE', 'WAITER', 'WAITRESS', 'COMPUTER', 'FOOTBALLER', 'PAINTER', 'WORK', 'COOK', 'FOOTBALL', 'PHOTOGRAPHER', 'WORKER', 'CUSTOMER', 'GUEST', 'PILOT', 'WRITER', 'DENTIST', 'POLICE', 'OFFICER', 'DESK', 'INSTRUCTIONS', 'QUEEN', 'DIARY', 'JOB', 'RECEPTIONIST'];

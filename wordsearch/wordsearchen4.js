  (function e(t, n, r) { function s(o, u) { if (!n[o]) { if (!t[o]) { var a = typeof require == "function" && require; if (!u && a) return a(o, !0); if (i) return i(o, !0); throw new Error("Cannot find module '" + o + "'") } var f = n[o] = { exports: {} }; t[o][0].call(f.exports, function (e) { var n = t[o][1][e]; return s(n ? n : e) }, f, f.exports, e, t, n, r) } return n[o].exports } var i = typeof require == "function" && require; for (var o = 0; o < r.length; o++)s(r[o]); return s })({
    1: [function (require, module, exports) {
      ...
      (function () {
        module.exports = ['BALL', 'FOOTBALL', 'RIDING', 'SWIMMING', 'BADMINTON', 'FOOTBALL', 'PLAYER', 'RUGBY', 'SWIMMING', 'COSTUME', 'BASEBALL', 'GAME', 'RUN', 'SWIMMING', 'POOL', 'BASKETBALL', 'GOAL', 'SAILING', 'SWIMSUIT', 'BAT', 'GOLF', 'SEA', 'TABLE', 'TENNIS', 'BATHING', 'SUIT', 'HOCKEY', 'SKATE', 'TEAM', 'BEACH', 'KIT', 'SKATEBOARD', 'TENNIS', 'BICYCLE', 'LUCK', 'SKI', 'TENNIS', 'PLAYER', 'BIKE', 'MEMBER', 'SKIING', 'THROW', 'BOAT', 'PLAY', 'SNOWBOARD', 'TICKET', 'CATCH', 'CLIMB', 'PLAYER', 'POOL', 'SNOWBOARDING', 'SOCCER', 'TIRED', 'TRAINERS', 'CLUB', 'COACH', 'COMPETITION', 'CRICKET', 'CYCLING', 'ENTER', 'FISHING', 'PRACTICE', 'PRACTISE', 'PRIZE', 'RACE', 'RACKET', 'REST', 'RIDE', 'SPORT', 'SPORTS', 'CENTRE', 'STADIUM', 'SURF', 'SURFBOARD', 'SURFBOARDING', 'SWIM', 'VERSUS', 'VOLLEYBALL', 'WALK', 'WATCH', 'WIN', 'WINDSURFING', 'WINNER'];

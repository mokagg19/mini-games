  (function e(t, n, r) { function s(o, u) { if (!n[o]) { if (!t[o]) { var a = typeof require == "function" && require; if (!u && a) return a(o, !0); if (i) return i(o, !0); throw new Error("Cannot find module '" + o + "'") } var f = n[o] = { exports: {} }; t[o][0].call(f.exports, function (e) { var n = t[o][1][e]; return s(n ? n : e) }, f, f.exports, e, t, n, r) } return n[o].exports } var i = typeof require == "function" && require; for (var o = 0; o < r.length; o++)s(r[o]); return s })({
    1: [function (require, module, exports) {
      ...
      (function () {
        module.exports = ['ADULT', 'AFRAID', 'ALBUM', 'ALONG', 'BELOW', 'BORING', 'BOSS', 'BREAKFAST', 'CAMERA', 'CAMPING', 'CANNOT', 'CASH', 'CATCH', 'CHAIN', 'CHANNEL', 'CHATROOM', 'CLASS', 'CLEAR', 'CLUB', 'CRAZY', 'CREAM', 'CROSS', 'DAUGHTER', 'DEAD', 'DESSERT', 'DRAWER', 'DRIVE', 'EASY', 'ENTRANCE', 'ERASER', 'EVEN', 'EVERYBODY', 'EVERYTHING', 'EVERYWHERE', 'EXAMINATION/EXAM', 'EXPLORER', 'FAN', 'FIFTEEN', 'FIRST', 'FORM', 'FORTY', 'FRIEND', 'HERSELF', 'HILL', 'INDOOR', 'JOURNEY', 'KEYBOARD', 'LATE', 'MAKE', 'MAY', 'MINERAL', 'MINUTE', 'MOUSE', 'MUSEUM', 'NEIGHBOR', 'NEWS', 'NORMAL', 'PILOT', 'PIZZA', 'PLASTIC', 'PLATE', 'POLICE', 'POSSIBLY', 'RETURN', 'ROUND', 'SAVE', 'SEE', 'SEVERAL', 'SHOE', 'SHOPPER', 'SILVER', 'SKATE', 'SKY', 'STORY', 'STREET', 'STUDIES', 'SURF', 'TEA', 'TENNIS', 'TENT', 'THANK', 'THAT', 'THEN', 'THING', 'THINK', 'TOE', 'TOGETHER', 'UNUSUAL', 'VIEW', 'VILLAGE', 'WAITER', 'WASH', 'WELL', 'WHILE', 'WOODEN', 'WORK', 'WORRIED', 'WRONG'];

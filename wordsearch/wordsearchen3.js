  (function e(t, n, r) { function s(o, u) { if (!n[o]) { if (!t[o]) { var a = typeof require == "function" && require; if (!u && a) return a(o, !0); if (i) return i(o, !0); throw new Error("Cannot find module '" + o + "'") } var f = n[o] = { exports: {} }; t[o][0].call(f.exports, function (e) { var n = t[o][1][e]; return s(n ? n : e) }, f, f.exports, e, t, n, r) } return n[o].exports } var i = typeof require == "function" && require; for (var o = 0; o < r.length; o++)s(r[o]); return s })({
    1: [function (require, module, exports) {
      ...
      (function () {
        module.exports = ['AIRPLANE', 'EXPLORER', 'PARK', 'STREET', 'AIRPORT', 'FAR', 'PASSENGER', 'SUITCASE', 'AMBULANCE', 'FLIGHT', 'PASSPORT', 'TAXI', 'BACKPACK', 'FLY', 'PETROL', 'TICKET', 'BOAT', 'GARAGE', 'PETROL', 'STATION', 'TOUR', 'BRIDGE', 'HELICOPTER', 'PILOT', 'TOUR', 'GUIDE', 'BUS', 'JOURNEY', 'PLATFORM', 'TOURIST', 'BUS', 'STATION', 'LEAVE', 'RAILWAY', 'TOURIST', 'INFORMATION', 'CENTER', 'BUS', 'STOP', 'CAR', 'LEFT', 'LIGHT', 'REPAIR', 'RETURN', 'TRAFFIC', 'TRAFFICLIGHT', 'CASE', 'LUGGAGE', 'RIDE', 'TRAM', 'COACH', 'MACHINE', 'RIGHT', 'TRAVEL', 'COUNTRY', 'MAP', 'ROAD', 'TRIP', 'DELAY', 'MECHANIC', 'ROUNDABOUT', 'TIRE', 'DELAYED', 'MIRROR', 'SAILING', 'UNDERGROUND', 'DRIVE', 'MISS', 'SEAT', 'VISIT', 'DRIVER', 'MOTORBIKE', 'SHIP', 'VISITOR', 'DRIVING', 'MOTORWAY', 'STATION', 'WAY', 'ENGINE', 'MOVE', 'STOP', 'WHEEL', 'ENGINEER', 'OIL', 'STRAIGHT', 'ON', 'WINDOW'];

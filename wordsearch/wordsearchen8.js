  (function e(t, n, r) { function s(o, u) { if (!n[o]) { if (!t[o]) { var a = typeof require == "function" && require; if (!u && a) return a(o, !0); if (i) return i(o, !0); throw new Error("Cannot find module '" + o + "'") } var f = n[o] = { exports: {} }; t[o][0].call(f.exports, function (e) { var n = t[o][1][e]; return s(n ? n : e) }, f, f.exports, e, t, n, r) } return n[o].exports } var i = typeof require == "function" && require; for (var o = 0; o < r.length; o++)s(r[o]); return s })({
    1: [function (require, module, exports) {
      ...
      (function () {
        module.exports = ['APARTMENT', 'COLLEGE', 'HOSPITAL', 'SCHOOL', 'BANK', 'BLOCK', 'BOOKSHOP', 'DEPARTMENT', 'STORE', 'DISCO', 'ELEVATOR', 'HOTEL', 'HOUSE', 'LIBRARY', 'SHOP', 'SPORTS', 'CENTER', 'STADIUM', 'BOOKSTORE', 'ENTRANCE', 'LIFT', 'SUPERMARKET', 'BUILDING', 'EXIT', 'MUSEUM', 'SWIMMING', 'POOL', 'CAFE', 'FACTORY', 'OFFICE', 'THEATRE', 'CAFETERIA', 'FLAT', 'PHARMACY', 'UNIVERSITY', 'CASTLE', 'GARAGE', 'POLICE', 'STATION', 'CATHEDRAL', 'GROCERY', 'STORE', 'POST', 'OFFICE', 'CINEMA', 'GUEST-HOUSE', 'RAILWAY', 'STATION', 'AREA', 'FOREST', 'PATH', 'SKY', 'BEACH', 'HILL', 'RAILWAY', 'VILLAGE', 'CAMPSITE', 'ISLAND', 'RAINFOREST', 'WOOD', 'FARM', 'LAKE', 'RIVER', 'FIELD', 'MOUNTAIN', 'SEA', 'AIRPORT', 'CITYCENTRE', 'PETROL', 'STATION', 'BRIDGE', 'BUS', 'STATION', 'CORNER', 'MARKET', 'PLAYGROUND', 'ROAD', 'STREET', 'TOWN', 'BUS', 'STOP', 'MOTORWAY', 'ROUNDABOUT', 'UNDERGROUND', 'CAR', 'PARK', 'SQUARE', 'ZOO'];

  (function e(t, n, r) { function s(o, u) { if (!n[o]) { if (!t[o]) { var a = typeof require == "function" && require; if (!u && a) return a(o, !0); if (i) return i(o, !0); throw new Error("Cannot find module '" + o + "'") } var f = n[o] = { exports: {} }; t[o][0].call(f.exports, function (e) { var n = t[o][1][e]; return s(n ? n : e) }, f, f.exports, e, t, n, r) } return n[o].exports } var i = typeof require == "function" && require; for (var o = 0; o < r.length; o++)s(r[o]); return s })({
    1: [function (require, module, exports) {
                ...
                if (__indexOf.call($scope.words, foundWord) >= 0) {
                  ...
                  if ($scope.words.length === 0) {
                    ...
                    alertCongrats = function () {
                      return alert("Congratulations, you found all " + $scope.foundWords.length + " words! Select a new difficulty level from the menu to play again.");
                    };
      ...
      (function () {
        module.exports = ['BIOLOGIA', 'CIENCIA', 'VIDA', 'TRATADO', 'GENETICA', 'CELULA', 'ECOLOGIA', 'ORGANISMOS', 'ANIMAL', 'VEGETAL', 'ECOSISTEMA', 'CIENCIA', 'FARMACO', 'MEDICINA', 'PLANETA', 'CONSERVACION', 'GENOMA', 'AMBIENTE', 'METODO', 'PLANTAS', 'ESPECIE', 'MACROSCOPICO', 'MICROSCOPICO', 'POBLACION', 'OBSERVACION', 'HIPOTESIS', 'EXPERIMENTACION', 'DEMOSTRACION', 'RESULTADOS', 'CONCLUSIONES', 'HOMEOSTASIS', 'HERENCIA', 'EVOLUCION', 'TAXONOMIA', 'COMPETENCIA', 'ADAPTACION', 'FISICA', 'QUIMICA', 'GEOLOGIA', 'TIERRA', 'MATEMATICAS', 'ETICA', 'HISTORIA', 'SOCIOLOGIA', 'TIERRA', 'UNIVERSO'];

  (function e(t, n, r) { function s(o, u) { if (!n[o]) { if (!t[o]) { var a = typeof require == "function" && require; if (!u && a) return a(o, !0); if (i) return i(o, !0); throw new Error("Cannot find module '" + o + "'") } var f = n[o] = { exports: {} }; t[o][0].call(f.exports, function (e) { var n = t[o][1][e]; return s(n ? n : e) }, f, f.exports, e, t, n, r) } return n[o].exports } var i = typeof require == "function" && require; for (var o = 0; o < r.length; o++)s(r[o]); return s })({
    1: [function (require, module, exports) {
      ...
      (function () {
        module.exports = ['ABILITY', 'ACHIEVE', 'ACTRESS', 'ADD', 'ADMISSION', 'AIRLINE', 'ALSO', 'ANXIOUS', 'BACK', 'BANANA', 'BAND', 'BEACH', 'BEAUTY', 'BETTER', 'BLOG', 'BOIL', 'BORDER', 'BORED', 'BOSS', 'BOTHER', 'BUG', 'BULL', 'BUSINESS', 'BUSINESSMAN', 'CARS', 'CHAMPIONSHIP', 'CHATROOM', 'CHEEKS', 'CHICKEN', 'CHIPS', 'CHIPS', 'CLAP', 'COACH', 'COMPETITION', 'COOKING', 'CORNER', 'COTTON', 'COUNTRYSIDE', 'CURTAINS', 'DAD', 'DANCING', 'DIRTY', 'DISCUSS','DISCUSSION', 'DISGUSTING', 'DISH', 'DOWNSTAIRS', 'DULL', 'EARTH', 'EAT', 'ECONOMICS', 'ELDER', 'EMPLOYER', 'ENGAGED', 'ENTRY', 'EVER', 'EXCEPTION', 'FEAR', 'FILES', 'FILLED', 'FILM', 'FIRST', 'FLOAT', 'FLOWER', 'FORWARD', 'FRENCH', 'GAIN', 'GAP', 'GARDEN', 'GENTLE', 'GIRLFRIEND', 'GLASSES', 'GOAT', 'GOING', 'GOLD', 'GRANDPA', 'GREAT', 'GYM', 'HAIRDRESSER', 'HATE', 'HEART', 'HELMET', 'HEY', 'HIS', 'HIT', 'HONEST', 'HUNGER', 'INJURE', 'INK', 'INSTANCE', 'INSTRUCTIONS', 'IRONING', 'ISLAND', 'JUG', 'KEEP', 'KITTEN', 'LAWYER', 'LAZY', 'LEATHER', 'LIE', 'LIGHTER', 'LION', 'LITTLE', 'LIVE', 'LUCKY', 'MANAGER', 'MARKET', 'MARRIED', 'MECHANIC', 'MEMBER', 'MOBILE', 'MOTORWAY', 'MOUSTACHE', 'MUSICAL', 'NASTY', 'NAVY', 'NOTEPAPER', 'NUMBER', 'OFFER', 'ONLINE', 'OURSELVES', 'PASSPORT', 'PET', 'PHYSICS', 'PIANO', 'PLAN', 'PLAY', 'POWER', 'PREPARE', 'PREPARED', 'PREVIOUS', 'PROBLEMS', 'PUPIL', 'PUSH', 'QUARTER', 'QUEUE', 'QUICK', 'REACH', 'REBUILD', 'REGULAR', 'ROUGH', 'SALARY', 'SEARCH', 'SEASIDE', 'SEATS', 'SELECT', 'SEND', 'SERVER', 'SHAVE', 'SHEET', 'SHORTS', 'SICK', 'SIGNATURE', 'SIMILAR', 'SINCE', 'SIR', 'SKILL', 'SLIM', 'SLIP', 'SOCIETY', 'SOMEHOW', 'SOMEONE', 'SPY', 'STEAL', 'STEEP', 'STONE', 'STRAWBERRY', 'SUNDAY', 'SUNGLASSES', 'SURFBOARD', 'TALL', 'TAP', 'TASTES', 'TEARS', 'TOMATO', 'TONGUE', 'TOO', 'TOOTHACHE', 'TOUR', 'TOWER', 'TRIP', 'UNDERPANTS', 'UNHAPPY', 'UNUSUAL', 'UPON', 'WAY', 'WENT', 'WEST', 'WESTERN', 'WHATEVER', 'WIDE', 'WITH'];

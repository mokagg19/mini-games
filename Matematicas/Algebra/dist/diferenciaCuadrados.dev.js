...
function setBoard() {
  for (var i = 0; i < 5; i++) {
    ...
    if (binomials[i][0] == "") {
      ...
      solutionNumberX = Math.pow(binomials[i][0], 2) + "x";
    }
    ...
    if (binomials[i][2] == "") {
      ...
      solutionNumberY = Math.pow(binomials[i][2], 2) + "y";
    }
  ...
  for (var i = 0; i < 5; i++) {
    var x2 = "<span id='numberX2" + i + "'>" + solutionBinomial[i][0] + "<sup id='xExponent2" + i + "'>" + solutionBinomial[i][1] + "</sup>";
    var x = "<span id='numberX" + i + "'>" + binomials[i][0] + "</span<span id='x" + i + "'>x</span><sup id='xExponent" + i + "'>" + binomials[i][1] + "</sup>";
    var y2 = "<span id='numberY" + i + "'>" + solutionBinomial[i][2] + "</span><sup id='yExponent" + i + "'>" + solutionBinomial[i][3] + "</sup>";
    var y = "<span id='numberY" + i + "'>" + binomials[i][2] + "</span<span id='y" + i + "'>y</span><sup id='yExponent" + i + "'>" + binomials[i][3] + "</sup>";
    var inputNumberX1 = "<input type='text' id='inputX1" + i + "' class='number'><sup><input type='text' id='exponentX1" + i + "' class='exponent''></sup>";
    var inputNumberX2 = "<input type='text' id='inputX2" + i + "' class='number'><sup><input type='text' id='exponentX2" + i + "' class='exponent''></sup>";
    ...
    var inputNumberY1 = "<input type='text' id='inputY1" + i + "' class='number''><sup><input type='text' id='exponentY1" + i + "' class='exponent''></sup>";
    var inputNumberY2 = "<input type='text' id='inputY2" + i + "' class='number''><sup><input type='text' id='exponentY2" + i + "' class='exponent''></sup>";

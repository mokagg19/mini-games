...
function answer() {
  ...
  if (reset == false) {
    for (var i = 0; i < 5; i++) {
      ...
      var solx2 = Math.pow(solutionBinomial[i][0], 2);
      var solx2E = solutionBinomial[i][2] * 2;
      var soly2 = Math.pow(solutionBinomial[i][3], 2);
      var x2 = "";
      ...
      var y2 = soly2 + binomials[i][4] + solutionBinomial[i][5] * 2;
      var incorrect = false;
      ...
      if (incorrect == true) {
        ...
        var ea2 = "<b>Cuadrado del primer t&eacutermino</b>.<br>(" + x + ")<sup>2</sup> <br>= " + solutionBinomial[i][0] + "<sup>2</sup>(" + solutionBinomial[i][1] + "<sup>" + solutionBinomial[i][2] + "<sup>2</sup></sup>) <br>= " + Math.pow(solutionBinomial[i][0], 2) + solutionBinomial[i][1] + "<sup>(" + solutionBinomial[i][2] + " * 2)</sup> <br>= " + x2 + "<br><br>";
        var e2ab = "<b>El doble del producto del primero por el segundo:</b><br> 2(" + solutionBinomial[i][0] + solutionBinomial[i][1] + "<sup>" + solutionBinomial[i][2] + "</sup>)(" + solutionBinomial[i][3] + solutionBinomial[i][4] + "<sup>" + solutionBinomial[i][5] + "</sup>)<br>= (2 *" + solutionBinomial[i][0] + " * " + solutionBinomial[i][3] + ")" + solutionBinomial[i][1] + "<sup>" + solutionBinomial[i][2] + "</sup>" + solutionBinomial[i][4] + "<sup>" + solutionBinomial[i][5] + "</sup><br>= " + 2 * solutionBinomial[i][0] * solutionBinomial[i][3] + solutionBinomial[i][1] + "<sup>" + solutionBinomial[i][2] + "</sup>" + solutionBinomial[i][4] + "<sup>" + solutionBinomial[i][5] + "</sup> =<br>" + xy + "<br><br>"; //var eab2 = "<b>El triple producto del primero por el cuadrado del segundo:</b><br> 3(" + solutionBinomial[i][0] + "x<sup>" + solutionBinomial[i][1] + "</sup>)(" + solutionBinomial[i][2] + "y<sup>" + solutionBinomial[i][3] + "</sup>)<sup>2</sup><br> = 3(" + solutionBinomial[i][0] * (solutionBinomial[i][2] ** 2) + "x<sup>" + solutionBinomial[i][1] + "</sup>y<sup>" + solutionBinomial[i][3]*2 + "</sup>)<br>= 3(" + (solutionBinomial[i][0]*(solutionBinomial[i][2])**2) + "x<sup>" + solutionBinomial[i][1] + "</sup>y<sup>" + solutionBinomial[i][3]*2 + "</sup>)<br>= " + ab2 + "<br><br>"

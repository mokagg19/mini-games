...
function setBoard() {
    ...
    for (var i = 0; i < numEjercicio; i++) {
        ...
        solution.push(numeroA**2, X[variableX], exponenteA*2, numeroB**2, Y[variableY], exponenteB*2);
    ...
    for (var i = 0; i < numEjercicio; i++) {
        ...
        if (solutionBinomial[i][0] == 1) {
            px2 = "<span id='numberX2" + i + "'></span<span id='x" + i + "'>" + solutionBinomial[i][1] + "</span>";
        } else {
            px2 = "<span id='numberX2" + i + "'>" + solutionBinomial[i][0] + "</span<span id='x" + i + "'>" + solutionBinomial[i][1] + "</span>";
        }

        var px2E = "";
        if (solutionBinomial[i][2] == 1) {
            px2E = "<sup id='xExponent" + i + "'>" + solutionBinomial[i][2] + "</sup>"
        } else {
            px2E = "<sup id='xExponent" + i + "'>" + solutionBinomial[i][2] + "</sup>"
        }

        var pxy = "<span id='number2xy" + i + "'>" + (solutionBinomial[i][0] * solutionBinomial[i][3] * 2) + "</span>" + solutionBinomial[i][1] + "<sup>";


        var py2 = "";
        if (solutionBinomial[i][3] == 1) {
            py2 = "<span id='numberY2" + i + "'></span<span id='y" + i + "'>" + solutionBinomial[i][4] + "</span>"
        } else {
            py2 = "<span id='numberY2" + i + "'>" + solutionBinomial[i][3] + "</span<span id='y" + i + "'>" + solutionBinomial[i][4] + "</span>"
        }

        var py2E = "";
        if (solutionBinomial[i][5] == 1) {
            py2E = "<sup id='yExponent" + i + "'></sup>"
        } else {
            py2E = "<sup id='yExponent" + i + "'>" + solutionBinomial[i][5] + "</sup>"
        }

...
function setBoard() {
    ...
    for (var i = 0; i < 5; i++) {
        ...
        var inputNumbera3 = "<input type='number' id='inputa3" + i + "' class='number'>x<sup><input type='number' id='exponenta3" + i + "' class='exponent''></sup>";
        var inputNumber3a2 = "<input type='number' id='inputa2" + i + "' class='number'>x<sup><input type='number' id='exponenta2" + i + "' class='exponent''></sup>"
        var inputNumberb = "y<sup><input type='number' id='exponentb" + i + "' class='exponent'></sup>"
        var inputNumber3a = "<input type='number' id='input3a" + i + "' class='number'>x<sup><input type='number' id='exponent3a" + i + "' class='exponent''></sup>";
        var inputNumberb2 = "y<sup><input type='number' id='exponentb2" + i + "' class='exponent'></sup>";
        var inputNumberb3 = "<input type='number' id='inputb3" + i + "' class='number'>y<sup><input type='number' id='exponentb3" + i + "' class='exponent''></sup>"

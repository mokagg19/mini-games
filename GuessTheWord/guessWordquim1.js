...
let phrases = [
    'Rutherford', 'fision nuclear', 'fusion nuclear', 'radiacion neutronica', 'radiacion ultravioleta', 'radiacion infrarroja'
]

var clues = [
    'Cient&iacute;fico que propuso que toda la masa del &aacute;tomo estaba concentrada en el n&uacute;cleo', 'ocurre cuando un n&uacute;cleo pesado se divide en dos o m&aacute;s n&uacute;cleos m&aacute;s pequeños', 'ocurre cuando varios n&uacute;cleos at&oacute;micos de carga similar se unen y forman un n&uacute;cleo m&aacute;s pesado', 'radiaci&oacute;n que consiste en neutrones libres producidos como resultado de reacciones nucleares, tales como la fisi&oacute;n nuclear o la fusi&oacute;n nuclear', 'energ&iacute;a electromagn&eacute;tica emitida a longitudes de onda menores a la visible por el ojo humano y que provienen del sol', 'radiaci&oacute;n electromagn&eacute;tica de mayor longitud de onda que la luz visible, es emitida por cualquier cuerpo con temperatura mayor al cero absoluto'
]
